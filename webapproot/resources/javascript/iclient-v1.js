TYRO = function() {
        ...
        return {
            build: function(cfg) {
                ...
                if (typeof cfg.origin === "string") {
                    var oMatch;
                    if (cfg.origin === "*") validOrigin = true; else if (null !== (oMatch = cfg.origin.match(/^https?:\/\/(?:[-a-zA-Z0-9_\.])+(?::\d+)?/))) {
                            ...
                            try {
                                ...
                                if (typeof e === "string") {
                                    ...
                                    if (e && s_isArray(e) && e.length == 2) {
                                        ...
                                        error = e.error;
                                        if (!e.message) message = ""; else if (typeof e.message === "string") message = e.message; else e = e.message;
                                    }
                                }
                                if (message === null) {
                                    try {
                ...
                var obj = {
                    ...
                    call: function(m) {
                        ...
                        if (m.timeout) setTransactionTimeout(s_curTranId, m.timeout, scopeMethod(m.method));
                        outTbl[s_curTranId] = {
                            callbacks: callbacks,
                            error: m.error,
                            success: m.success
    ...
    function validateTerminalBusinessDay(terminalBusinessDay, failureCallback) {
        if (!terminalBusinessDay || !containsOnlyNumbers(terminalBusinessDay) || terminalBusinessDay.length !== 8) {
            failureCallback({
                result: "failure",
                error: "Valid terminal business day must be provided"
            });
    ...
    function validateReportFormat(reportFormat, failureCallback) {
        if (!reportFormat || reportFormat !== "xml" && reportFormat !== "txt") {
            failureCallback({
                result: "failure",
                error: "Valid report format must be provided"
            });
    ...
    function validateReportType(reportType, failureCallback) {
        if (!reportType || reportType !== "summary" && reportType !== "detail") {
            failureCallback({
                result: "failure",
                error: "Valid report type must be provided"
            });
    ...
    SHARED_INTERFACE.addSharedApiBindingsVersion1 = function(tta, channelGetter, channelDestroyer) {
        ...
        tta.healthpointReconciliationReport = function(parameters, responseReceivedCallback) {
            ...
            channel.notify({
                method: "healthpointReconciliationReport",
                params: parameters
            });
        };
    };
    ...
    exports.IClient = function(apiKey, posProductData, documentToBindTo) {
        ...
        this.initiatePurchase = function(requestParams, transactionCallbacks) {
            ...
            channel.notify({
                ...
                params: $.extend(requestParams, {
                    posProductData: this.posProductData
                })
            });
        };
        ...
        this.terminalInfo = function(responseReceivedCallback) {
        ...
        this.getConfiguration = function(callback) {
            ...
            channel.call({
                ...
                success: notifyPosAndDestroyChannel
            });
        };
        ...
        function createChannel() {
            ...
            var iframeSourceUrl = "https://iclient.test.tyro.com/";
            ...
            iframe.setAttribute("id", "iclient-iframe");
        ...
        function destroyChannel() {
            var iframe = doc.getElementById("iclient-iframe");
...
//@ sourceMappingURL=iclient-v1.source-map.json